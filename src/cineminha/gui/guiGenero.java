...
public class guiGenero extends javax.swing.JFrame {
    private cineminha.controle.controleGenero controlegenero;
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            LstGeneros.setListData(controlegenero.atualizarLista().toArray());
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Ta dando ruim aqui!!");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (LstGeneros.getSelectedValue() != null) {
            ...
            try {
                controlegenero.excluir(g.getId());
        ...
        try {
            ...
            Logger.getLogger(guiGenero.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void LstGenerosValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_LstGenerosValueChanged
        ...
        txtId.setText(Long.toString(genero.getId()));
        //txtId.setText(L);
